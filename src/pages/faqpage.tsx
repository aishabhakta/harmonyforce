  ...
  return (
    <Box sx={{ display: "flex", flexDirection: "column", minHeight: "100vh" }}>
      ...
      <Container maxWidth="md" sx={{ textAlign: "center", mb: 8 }}>
        ...
        <Typography variant="subtitle1" sx={{ mb: 4, color: "gray" }}>
          Couldn't find the answer to your question? Reach out to us!
        </Typography>

        <Box component="form" sx={{ display: "flex", flexDirection: "column", gap: 2, maxWidth: 500, mx: "auto" }}>
          <TextField label="Email address" fullWidth defaultValue="john@gmail.com" />
          <TextField label="Subject" fullWidth placeholder="Enter subject" />
          <TextField label="Message" fullWidth placeholder="Enter your message" multiline rows={4} />
          <Button variant="contained" sx={{ backgroundColor: "#1976d2", color: "white", mt: 2 }}>
            Submit
          </Button>
        </Box>
      </Container>
